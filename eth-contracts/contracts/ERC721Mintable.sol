...
contract Ownable {
    ...
    modifier isValidAddress(address to) {
        require(to != address(0), 'Only owner can perform this action!');
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "New owner can't be current owner!");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(_isApprovedOrOwner(msg.sender, tokenId), 'This function has to be approved or owner!');
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        address owner = ownerOf(tokenId);
        require(from == owner, 'From address is not owner adress!');
...
//      - make the base token uri: https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/
    constructor() ERC721Metadata('RealEstate', 'REAL', 'https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/') public {}
